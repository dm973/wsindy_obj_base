...
...    compterm(term('ftag',2),diffOp([1,0])),...                                    % term nonlinear in a derivative
...    prodterm(term('ftag',-1i),diffOp([2,0])),...                            % product of two terms
...    addterm(diffOp([2,0]), term('fHandle',@(u) tanh(u))),...  % sum of two terms
    };
