function [weights,x,t,x0,ode_name,ode_params,rhs] = gen_ode_data(ode_num,ode_params,tspan,x0,tol_ode)
...
% Simulate ODE
    ...
    weights = cellfun(@(w)[w(:,1:length(x0)) zeros(size(w,1),1),w(:,end)],weights,'un',0);
